---
name: git-workflow
description: Safely manage Git status, branches, commits, pushes, and pull requests while preserving unrelated work. Use for commit preparation, branch operations, publishing changes, or PR creation.
category: workflow
---
